...
class MenuDrawer extends HTMLElement {
  ...
  bindEvents() {
    ...
    this.querySelectorAll('button.menu-drawer__close-button, button.mobile-facets__close-button').forEach(button => button.addEventListener('click', this.onCloseButtonClick.bind(this)));
  }
...
var links = document.links;
for (let i = 0, linksLength = links.length ; i < linksLength ; i++) {
  if (links[i].hostname == 'b2b.beaumont-amsterdam.com') {
    links[i].target = '_blank';
    links[i].rel = 'noreferrer noopener';
  }
}
